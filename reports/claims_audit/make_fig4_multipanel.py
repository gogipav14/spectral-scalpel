...
# ---------------------------------------------------------------
with open("/home/gogip/github_repos/spectral-scalpel-private/reports/claims_audit/recoverability_bound_data.pkl", "rb") as f:
    three_systems = pickle.load(f)

# ---------------------------------------------------------------
# Panel (b): float32 vs float64 in physical k_perp units
# ---------------------------------------------------------------
with open("/home/gogip/github_repos/spectral-scalpel-private/reports/claims_audit/precision_scaling_data.pkl", "rb") as f:
...
plt.tight_layout()
out = "/home/gogip/github_repos/spectral-scalpel-private/paper_pnas/figures/recoverability_bound.png"
