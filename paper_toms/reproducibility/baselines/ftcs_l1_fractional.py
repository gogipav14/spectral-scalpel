...
paper_toms/article.tex Fig. 3(b).
...
def build_l1_solver(n_t: int):
    ...
    ``reports/claims_audit/benchmark_fractional_heat_3d.py:make_l1_scan_fn``.
    """
    from reports.claims_audit.benchmark_fractional_heat_3d import make_l1_scan_fn
...
def show_parameters() -> None:
    ...
    print(f"  canonical kernel      = "
          f"reports/claims_audit/benchmark_fractional_heat_3d.py:make_l1_scan_fn")
