...
Used by reproducibility/reproduce.sh to verify a fresh
reproduction matches the archived CSVs in reproducibility/data/.

Exit code 0 = all rows within tolerance; non-zero = drift detected.

Usage:
    python csv_diff.py --archive paper_toms/data --regen reproducibility/figures --tolerance 0.05
"""
